...
public class AddStudentPanel extends JPanel {
	...
	public AddStudentPanel() {
		setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Student information", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(51, 51, 51)));
